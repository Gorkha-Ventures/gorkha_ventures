...
export default function SubmissionDetailPage() {
  ...
  if (loading) return <main className="admin-shell"><div className="empty">Loading...</div></main>
  if (error) return <main className="admin-shell"><div className="empty">{error}</div></main>
  if (!item) return <main className="admin-shell"><div className="empty">Submission not found.</div></main>
